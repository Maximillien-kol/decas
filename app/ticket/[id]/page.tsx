...
export default function TicketPage() {
  ...
  if (!isValid || !ticketData) {
    return (
      <main className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-red-50 via-white to-red-50">
  ...
  const eventDate = new Date(ticketData.timestamp)

  return (
    <main className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-purple-50 p-4 py-8">
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        {/* Ticket Verification */}
        <Card className="bg-white/80 backdrop-blur-sm border-2 border-green-500 shadow-xl">
          <div className="p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h2 className="text-xl font-bold text-gray-900">Ticket Verified</h2>
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Gates open at 5:30 PM</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
                  <p className="font-semibold text-blue-900">Grand Celebration Hall</p>
                  <p className="text-gray-700 mt-1">KG 123 Street, Kigali</p>
                  <p className="text-gray-700">Kimihurura, Gasabo District</p>
                  <p className="text-sm text-blue-600 mt-2">Near Kigali Convention Centre</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="bg-indigo-50 rounded-lg p-4 border border-indigo-200">
                  <p className="font-semibold text-indigo-900 mb-2">Semi-Formal / Cocktail Attire</p>
        ...
        {/* Important Notes */}
        <Card className="bg-gradient-to-r from-amber-50 to-orange-50 border-2 border-amber-300 shadow-xl">
          <div className="p-6">
